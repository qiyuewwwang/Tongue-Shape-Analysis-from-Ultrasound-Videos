% get XY coordinates
XY = readmatrix('C:\Users\AT75690\Desktop\Tal corpus\fricative\perturbated\perturbated_5\s\p5_con_day6_see_273.csv');
m = size(XY,1);

%%%%%%%%%%  calculate DEI and LOC  %%%%%%%%%%
for i = 1:8
    x = XY(:,2*i-1);
    y = XY(:,2*i);
    ...
    writematrix(result,'C:\Users\AT75690\Desktop\Tal corpus\fricative\perturbated\perturbated_5\s\p5_D&L_day6_see_273.csv');
...
writematrix(len,'C:\Users\AT75690\Desktop\Tal corpus\fricative\perturbated\perturbated_5\s\p5_len_day6_see_273.csv');
...
writematrix(tf,'C:\Users\AT75690\Desktop\Tal corpus\fricative\perturbated\perturbated_5\s\p5_TF_day6_see_273.csv');
